...
class _WelcomeScreenState extends State<_WelcomeScreen> {
  late AvailableSpaceCubit availableSpaceCubit =
      context.read<AvailableSpaceCubit>();
                ...
                child: Column(
                      children: [
                        ...
                        WidgetSize(
                          onChange: (Size size) {
                            context
                                .read<AvailableSpaceCubit>()
                                .setHeight(constraints.maxHeight - size.height);
                          },
                          child: Padding(
                            padding: const EdgeInsets.fromLTRB(
                                cPadding, 0, cPadding, cPadding),
                            child: Column(
                              ...
                              children: [
                                ...
                                CenterTextIconButton(
                                  text: context.l10n
                                      .welcomeScreen_continueWithMethod(
                                          "Google"),
